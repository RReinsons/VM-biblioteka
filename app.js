(() => {
  ...
  const tr = {
    lv:{books:"Grāmatas",about:"Par bibliotēku",search:"Meklēt",searchPlaceholder:"Meklēt pēc nosaukuma, autora, tēmas, atslēgvārda…",pinNote:"Piespraustās grāmatas tiek rādītas vispirms.",clearPins:"Noņemt piespraustās grāmatas",sortBy:"Kārtot pēc:",perPage:"Grāmatas lapā:",aboutText:"",author:"Autors",year:"Gads",language:"Valoda",topic:"Tēma",copies:"Eksemplāri",available:"Pieejams",noResults:"Neviena grāmata neatbilst izvēlētajiem filtriem.",loading:"Ielādē katalogu…",results:n=>`${n} grāmatas`,prev:"Iepriekšējā",next:"Nākamā",all:"Visi",filterTopic:"Tēma",filterLanguage:"Valoda",filterYear:"Gads",sortNewest:"Jaunākie vispirms",sortOldest:"Vecākie vispirms",sortTitle:"Nosaukums A–Z",sortAuthor:"Autors A–Z",pin:"Piespraust",unpin:"Atspraust"},
    en:{books:"Books",about:"About the library",search:"Search",searchPlaceholder:"Search by title, author, topic or keyword…",pinNote:"Pinned books are shown first.",clearPins:"Remove pinned books",sortBy:"Sort by:",perPage:"Books per page:",aboutText:"",author:"Author",year:"Year",language:"Language",topic:"Topic",copies:"Copies",available:"Available",noResults:"No books match the selected filters.",loading:"Loading catalogue…",results:n=>`${n} books`,prev:"Previous",next:"Next",all:"All",filterTopic:"Topic",filterLanguage:"Language",filterYear:"Year",sortNewest:"Newest first",sortOldest:"Oldest first",sortTitle:"Title A–Z",sortAuthor:"Author A–Z",pin:"Pin",unpin:"Unpin"}
  };
